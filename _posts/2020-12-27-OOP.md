...
{% include feature_row id="feature_row_left_Abstraction" type="left" %}

Once that bundle is named, we can refer to it and, at times, ignore the details within the bundle.  


{% include feature_row id="feature_row_left_Encapsulation" type="left" %}

Examples


{% include feature_row id="feature_row_left_Inheritance" type="left" %}

Examples


{% include feature_row id="feature_row_left_Polymorphism" type="left" %}
