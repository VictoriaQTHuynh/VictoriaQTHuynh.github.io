...
Some light humor: from Homer and Marge Simpson "parent classes", you could either have Bart Simpson "child class" or Lisa Simpson "child class".
...
The two child classes - Class SiberianHusky and Class Beagle - can inherit from the parent class Dog.
...
<div style="width:95%; font-size:80%; text-align:center;">
<img src="/images/OOP/inheritance9.png" style="padding-bottom:0.5em;"/>
</div> 

### Example: Dog Walking
Child classes SiberianHusky and Beagle inherit the behaviors walk from the Parent class Dog.
...
<div style="width:40%; font-size:80%; text-align:center;">
<img src="/images/OOP/inheritance13.png" style="padding-bottom:0.5em;"/>
</div> 
